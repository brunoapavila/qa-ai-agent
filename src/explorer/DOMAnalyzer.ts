...
import { PageMap, ElementMap } from "../models/SystemMap";
...
export class DOMAnalyzer {
  ...
  private async getElements(selector: string): Promise<ElementMap[]> {
  ...
  private async getClickableElements(): Promise<ElementMap[]> {
